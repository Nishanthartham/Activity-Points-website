      ...
      <div className="parent">
        ...
        <div className="level1">
          <div
            className="child"
            style={myStyle}
            onClick={() => navigate("/viewhackathon")}
          >
            Hackathon
          </div>
          <div
            className="child"
            style={myStyle}
            onClick={() => navigate("/viewinternship")}
          >
            Internships
          </div>
          <div
            className="child"
            style={myStyle}
            onClick={() => navigate("/vieweightweek")}
          >
            8-week courses
          </div>
        </div>
        <div className="level2">
          <div
            className="child"
            style={myStyle}
            onClick={() => navigate("/viewtwelveweek")}
          >
            12-week courses
          </div>
          <div
